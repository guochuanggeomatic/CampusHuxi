...
public class FlyComponent {
     ...
     */
    public FlyComponent(Activity activity, String flyRouteFilePath) {
    ...
    public void startOrPauseFly(int position) {
        ...
        Log.d(LandmarkComponent.TAG, "startOrPauseFly: pos" + position + " cur" + curRouteIndex + " count:" + routes.getCount());
